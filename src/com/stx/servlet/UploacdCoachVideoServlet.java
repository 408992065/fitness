...
/**
 * Servlet implementation class UploacdCoachVideoServlet
 */
@WebServlet(name = "UploadCVideoServlet", urlPatterns = { "/uploadcvideo" })
public class UploacdCoachVideoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       private ICvideoDao dao=new cvideoDao();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UploacdCoachVideoServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (isMultipart) {
			...
			File file = new File(getServletContext().getRealPath("/uploadcoachvideo"));
			//end
			...
			try {
				...
				while (iter.hasNext()) {
					...
					if (item.isFormField()) {
						...
						vd.setUrl("/uploadcoachvideo/" + newFileName);
						//end
