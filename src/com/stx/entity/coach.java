...
public class coach {
	...
	public coach(int coachid, int userid, String wxname, String name, String openid, int age, double hight,
			double weight, int gender, String description, String curl, String ctime) {
	...
	public coach(int coachid, String name, int age, double hight, double weight, int gender, String description) {
		this.coachid = coachid;
		this.name = name;
		this.age = age;
		this.hight = hight;
